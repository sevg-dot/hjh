# Código viejo (sin casi filtros, pocos gráficos pero carga todo bien)
...
@st.cache_data(show_spinner=False, hash_funcs={"streamlit.runtime.uploaded_file_manager.UploadedFile": _hash_upload})
...
with tab3:
    if uploaded_software:
        ...
        lic = sw[sw["SOFTWARE"] == "Licenciado"] if "SOFTWARE" in sw.columns else sw
